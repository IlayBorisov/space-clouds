...
public partial class GameEntity {
    ...
    public Code.Gameplay.Common.Components.Id id { get { return (Code.Gameplay.Common.Components.Id)GetComponent(GameComponentsLookup.Id); } }
    ...
    public GameEntity AddId(int newValue) {
        ...
        var component = (Code.Gameplay.Common.Components.Id)CreateComponent(index, typeof(Code.Gameplay.Common.Components.Id));
