...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.Hero.Components.Health health { get { return (Code.Gameplay.Features.Hero.Components.Health)GetComponent(GameComponentsLookup.Health); } }
    ...
    public GameEntity AddHealth(int newValue) {
        ...
        var component = (Code.Gameplay.Features.Hero.Components.Health)CreateComponent(index, typeof(Code.Gameplay.Features.Hero.Components.Health));
